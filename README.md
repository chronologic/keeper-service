...
All logic described below is also executed at system startup to ensure proper operation.
...
| `ADMIN_EMAIL_RECIPIENTS`            | `string` |            | Comma-separated list of admin emails for notifications                                                                                       |
...
| `USER_TX_FEE_PERCENT`               | `number` | `0`        | All transactions executed to prevent a user from getting liquidated will have this fee added on top of it. This makes the system profitable. |
