...
export const DEPOSIT_SYNC_INTERVAL_MINUTES = Number(process.env.DEPOSIT_SYNC_INTERVAL_MINUTES || 5);
...
export const WARNING_SYSTEM_ETH_BALANCE = Number(process.env.WARNING_SYSTEM_ETH_BALANCE || 0);
